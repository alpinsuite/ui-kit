...
class _GalleryState extends State<_Gallery> {
  ...
  Widget _icons(SlateThemeData theme) {
    const glyphs = <String, SlateIconDraw>{
      ...
      'upload': SlateIcons.upload,
      'envelope': SlateIcons.envelope,
      'person': SlateIcons.person,
      'reply': SlateIcons.reply,
      'send': SlateIcons.send,
      'flag': SlateIcons.flag,
      'paste': SlateIcons.paste,
      'cut': SlateIcons.cut,
      'borders': SlateIcons.borders,
      'bordersOutline': SlateIcons.bordersOutline,
      'bordersNone': SlateIcons.bordersNone,
      'fillColor': SlateIcons.fillColor,
      'cellAlignTop': SlateIcons.cellAlignTop,
      'cellAlignMiddle': SlateIcons.cellAlignMiddle,
      'cellAlignBottom': SlateIcons.cellAlignBottom,
      'wrapText': SlateIcons.wrapText,
      'mergeCells': SlateIcons.mergeCells,
      'unmergeCells': SlateIcons.unmergeCells,
      'percent': SlateIcons.percent,
      'currency': SlateIcons.currency,
      'commaStyle': SlateIcons.commaStyle,
      'decimalIncrease': SlateIcons.decimalIncrease,
      'decimalDecrease': SlateIcons.decimalDecrease,
      'sigma': SlateIcons.sigma,
      'fx': SlateIcons.fx,
      'sortAscending': SlateIcons.sortAscending,
      'sortDescending': SlateIcons.sortDescending,
      'insertRow': SlateIcons.insertRow,
      'deleteRow': SlateIcons.deleteRow,
      'insertColumn': SlateIcons.insertColumn,
      ...
      'chartArea': SlateIcons.chartArea,
      'chartScatter': SlateIcons.chartScatter,
      'chartPie': SlateIcons.chartPie,
      'chartDoughnut': SlateIcons.chartDoughnut,
      'chartRadar': SlateIcons.chartRadar,
    };
